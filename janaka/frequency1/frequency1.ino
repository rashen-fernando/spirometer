...
else
{
  ...
  if(g<time_index)
  {
    ...
    {
    g++;
    avg_time=(avg_time*(g-1)+t[g-1])/(g*9600);
    breathing_freq=1/avg_time;
...
//averaging(for max val determination;fail-depends on time not maximum force)
if(y<no_of_samples)
{
